...
12. Wifi等の使っていないペリフェラルの電源を落として省電力化する事
13. 大きくなったネストを改善すること、ベタ書きを関数化して特にmain内の可読性を向上させること。ネストは基本2段まで、最大でも3段までの許容とする。コンテクストや役割毎にソース分割や関数化を行い、基本的にmainの中では関数の呼び出しだけを行う形にして可読性を向上させること。
