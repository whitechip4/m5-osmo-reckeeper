...
11. GPSのデータを録画時にOsmo360に送信すること。Protocolや使用方法はRefelenceのリポジトリのドキュメントとサンプルプログラムを参考にすること。
12. Wifi等の使っていないペリフェラルの電源を落として省電力化する事
13. LCDのデザインをUI/UXに基づき改善する事。画面が小さいことを考慮し、必要なものを大きく表示し視認性を高め、画面の占有率をなるべく上げる。また、必要性が低いものは小さく表示するなどデザインを熟考し、改善する事。
